...
const HeaderReact = ({ activePath }: Props) => {
    ...
    const desktopHeader = (
        <div className="flex justify-between items-center">
            <div className="flex items-baseline">
                <div className="text-2xl font-['Roboto'] pr-2">
                    Michael Reeve
                </div>
                <div className="text-xl [&>a]:mx-3 [&>a]:cursor-pointer">
                    ...
                    <a
                        className={
                            "hover:text-sky-500 " +
                            (activePath == "experience" ? "text-sky-500" : "")
                        }
                    ...
                    <a
                        className={
                            "hover:text-sky-500 " +
                            (activePath == "projects" ? "text-sky-500" : "")
                        }
                        href="/projects.html"
                    >
                        Projects
                    ...
                    <a
                        className={
                            "hover:text-sky-500 " +
                            (activePath == "contact" ? "text-sky-500" : "")
                        }
                        href="/contact.html"
                    >
                        Contact
            ...
            <div className="flex">
                <div className="bg-white dark:bg-[#161b22] rounded border dark:border-[#21262d] ml-1">
                    <a
                        target="_blank"
    ...
    const mobileHeader = (
        <>
            <div className="flex justify-between items-center">
                <a className="text-2xl font-['Roboto']" href="/">
                    Michael Reeve
                </a>
            ...
            {open && !isDesktopOrLaptop ? (
                <div className="text-lg [&>a]:my-2 [&>a]:inline-block">
                    <a
                        href="/"
                        className={activePath == "home" ? "text-sky-500" : ""}
                    >
                        Home
                    </a>{" "}
                    <br />
    ...
    return (
        <div
            className={
                "top-0 z-20 w-full h-14 " +
                (open && !isDesktopOrLaptop ? "sticky" : "")
            }
        >
